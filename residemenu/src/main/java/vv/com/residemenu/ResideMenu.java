...
public class ResideMenu extends FrameLayout {
    ...
    private vv.com.residemenu.TouchDisableView viewActivity;
    /**
    ...
    private void initValue(Activity activity) {
        ...
        viewActivity = new vv.com.residemenu.TouchDisableView(this.activity);
